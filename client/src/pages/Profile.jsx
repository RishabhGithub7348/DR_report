...
// save the appoinment glibally
  ...
  useEffect(() => {
    async function fetchForm(unique) {
      const response = await axios.get(`http://localhost:3001/form/${unique}`);
  ...
  useEffect(() => {
    async function fetchNotes(unique) {
      const response = await axios.get(`http://localhost:3001/api/notes/${unique}`);
...
//fetching the latest added appointment
  useEffect(() => {
    async function fetchLatestNote(unique) {
      const response = await fetch(`http://localhost:3001/api/latest/${unique}`);
      const data = await response.json();
      setLatestNote(data);
    }
  ...
  useEffect(() => {
    async function fetchFiles(unique) {
      const response = await fetch(`http://localhost:3001/files/${unique}`);
      const data = await response.json();
      setFiles(data);
  ...
  useEffect(() => {
    async function fetchRecords(unique) {
      const response = await fetch(`http://localhost:3001/api/add-record/${unique}`);
      const data = await response.json();
      setRecords(data);
